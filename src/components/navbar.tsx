...
export function Navbar() {
  return (
    <nav className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-gray-50 p-2 dark:border-gray-50 dark:bg-stone-900 dark:text-white">
      <Link to={`/`}>
        <RobotIcon />
      </Link>
